...
export class DisplayPost extends Component {
  ...
  handleComment = ({ id, addComments }) => {
    ...
    axios
      .post("https://linkedin-clone-harsh.herokuapp.com/comments", {
        post_id: id,
        addComments,
        user_id: cur_uid,
    ...
    return (
      <div className={styles.Container}>
        <div className={styles.PostContainer}>
          <div className={styles.FriendsDetails}>
            ...
            <div
              ...
              <div>
                ...
                <div style={{ float: "left" }}> 1st </div> <br />
              </div>
              <div>{title}</div>
              <div>
                <div style={{ float: "left", paddingRight: "0.4rem" }}>
                  {date} •
                </div>{" "}
          ...
          <div className={styles.PostData}>{data}</div>
          <div className={styles.LikesCommentsDiv}>
            <div className={styles.Likes}>
              <div>
                <img
                  src="https://static-exp3.licdn.com/sc/h/d310t2g24pvdy4pt1jkedo4yb"
                  alt="Like"
                />
              </div>
              <div>
                <img
                  src="https://static-exp3.licdn.com/sc/h/54ivsuv8nxk12frsw45evxn3r"
                  alt="Support"
                />
              </div>
              <div>
                <img
                  src="https://static-exp3.licdn.com/sc/h/5thsbmikm6a8uov24ygwd914f"
                  alt="Celebrate"
                />
              </div>
              <div style={{ paddingLeft: "0.5rem" }}>{likes}</div>
            </div>
        ...
        <div className={styles.FlexDisplay} style={{ padding: "1rem" }}>
          ...
          <div className={styles.FlexDisplay}>
            ...
            <div style={{ marginLeft: "-8rem" }} className={styles.FlexDisplay}>
              ...
              <div
                className={styles.EmojiImageComment}
        ...
        <div className={styles.LoadMoreComments}>Load more comments</div>
      </div>
    );
  }
}
